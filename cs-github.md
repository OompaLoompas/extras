Το Github είναι μία υπηρεσία που έχει ως επίκεντρό της το σύστημα Git, το οποίο επιτρέπει τη κατανομή και τη διαχείριση του πηγαίου κώδικα. Οι προγραμματιστές των Linux
